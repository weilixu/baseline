...
public final class HVACSystemImplUtil {
     ...
     * @param airflowRate
     */
    public static void updateFanPowerforSystem3To4(EplusObject eo,
	    double airflowRate) {
	...
	double supplymotorEff = FanPowerCalculation
		.getFanMotorEffciencyForSystem5To8(supplyAir);
	...
	for (int i = 0; i < supply.getSize(); i++) {
	    ...
	    } else if (supply.getKeyValuePair(i).getKey()
		    .equalsIgnoreCase("Motor Efficiency")) {
	...
	if (floorArea > coolingSmallFloorArea
		&& floorArea <= coolingMediumFloorArea) {
	    numberOfChiller = 2;
     ...
     */
    public static void plantConnectionForSys7(
	    ArrayList<EplusObject> plantSystem, ArrayList<String> chillerList,
	    ArrayList<String> towerList, ArrayList<String> boilerList,
     ...
     * @param sysCooilngCoilList
     */
    public static void plantConnectionForSys8(
	    ArrayList<EplusObject> plantSystem, ArrayList<String> chillerList,
     ...
     * @param zoneHeatingCoilList
     */
    public static void plantConnectionForSys5And6(
	    ArrayList<EplusObject> plantSystem, ArrayList<String> boilerList,
	    ArrayList<String> sysHeatingCoilList,
	    ArrayList<String> zoneHeatingCoilList) {
	...
	if (boilerList.isEmpty()) {
	    KeyValuePair newPair = new KeyValuePair("Branch Name",
		    "Boiler%" + postfix);
	    eo.insertFiled(index, newPair);
	} else {
