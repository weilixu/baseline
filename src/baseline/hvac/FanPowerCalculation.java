...
public final class FanPowerCalculation {
    ...
    /**
     * Acquire the fan power for system type 1 and 2, the air flow must be
     * m3/s. The return result's unit is watts
     * @param airFlow
     * @return
     */
    ...
    /**
     * calculate the fan power for system type 3 and system type 4.
    ...
    /**
     * Selet the motor efficiency for the fan, As stated in the G3.1.2.10
     * Fan Motor Efficiency is the efficiency from Table 10.8 for the next motor size greater than 
     * the bhp using a totally enclosed fancooled motor at 1800 rpm.
     * @param bhp
     * @return
     */
